  ...
  build: {
    rollupOptions: {
      input: {
        ...
        'procedural-flux': resolve(__dirname, 'procedural-flux.html'),
        'velocity-rift': resolve(__dirname, 'velocity-rift.html'),
        'pulse-array': resolve(__dirname, 'pulse-array.html'),
        'holographic-convergence': resolve(__dirname, 'holographic-convergence.html'),
        'magnetic-pulse': resolve(__dirname, 'magnetic-pulse.html'),
      },
    },
  },
});
